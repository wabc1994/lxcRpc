...
public class ConsistenHashRouter <T extends Node> {
    private final SortedMap<Long, VirtualNode <T>> ring =new TreeMap<>();
    private final HashFunction hashFunction;

    public ConsistenHashRouter(Collection<T> pNodes, int vNodeCount) {
        this(pNodes,vNodeCount, new MD5Hash());
    }
    public ConsistenHashRouter(Collection<T> pNodes, int vNodeCount, HashFunction hashFunction) {
